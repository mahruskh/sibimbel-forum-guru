    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-primary box-solid flat">
                <div class="box-body">
                    <a href="<?php echo base_url('administrator/add-admin');?>" class="btn btn-yahoo btn-flat active">Tambah Administrator</a> |
                    <a href="<?php echo base_url('administrator/show'); ?>" class="btn btn-yahoo btn-flat">Data
                        Administrator</a> |
                    <a href="<?php echo base_url('administrator/setup-akun') ?>" class="btn btn-yahoo btn-flat">Setup
                        Akun</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-7">
                    <div class="box box-primary flat">
                        <div class="box-body">
                            <form class="form-horizontal" action="add_new_admin" method="POST">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" row="3" name="alamat" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="submit" class="btn btn-primary" name="add_new_admin" value="SIMPAN">
