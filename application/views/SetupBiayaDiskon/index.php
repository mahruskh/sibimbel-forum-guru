            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<?php echo base_url('setup/biaya-diskon/show') ?>"><i
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-primary box-solid flat">
                <div class="box-body">
                    <a href="<?php echo base_url('setup/program-pilihan/show') ?>" class="btn btn-yahoo btn-flat">Program
                        & Pilihan</a> |
                    <a href="<?php echo base_url('setup/biaya-diskon/show') ?>" class="btn btn-yahoo btn-flat active">Biaya
                        & Diskon</a> |
                    <a href="<?php echo base_url('setup/tahun-ajaran/show') ?>" class="btn btn-yahoo btn-flat">Tahun
                        Ajaran</a> |
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control text-bold" name="biaya_pendaftaran"
                                               readonly="readonly">
                                    </div>
                                </div>
                ...
                <div class="col-sm-6 col-md-8">
                    <div class="box box-primary flat">
                        <div class="box-header with-border">
                            <h4 class="box-tittle">Diskon & Potongan Biaya</h4>
                            <div class="box-tools pull-right">
                                <button type="button" class="btn btn-primary btn-sm" onclick="add_diskon()"><span
                                            class="glyphicon glyphicon-plus"></span> Diskon
                                </button>
                            </div>
                        </div>
                        <div class="box-body">
        ...
        if ($('[name="kode_diskon"]').val() == "" || $('[name="jml_diskon"]').val() == "") {
            ...
            if (method_diskon == "add_diskon") {
                ...
                $.ajax({
                    ...
                    url: method_diskon,
                    data: {
                        id_diskon: id_update_diskon,
                        kode_diskon: $('[name="kode_diskon"]').val(),
                        jml_diskon: $('[name="jml_diskon"]').val()
                    },
                    success: function (data) {
                        if (data == 1) {
                            $("#modal-diskon").modal("hide")
